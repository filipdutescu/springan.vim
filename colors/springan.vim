...
call <sid>hi("Error",         s:gui00, s:gui09, s:cterm00, s:cterm09, "", "")
...
call <sid>hi("IncSearch",     s:gui00, s:gui06, s:cterm00, s:cterm06, "none", "")
...
call <sid>hi("Search",        s:gui00, s:gui10, s:cterm00, s:cterm10,  "", "")
call <sid>hi("Substitute",    s:gui00, s:gui10, s:cterm00, s:cterm10, "none", "")
call <sid>hi("SpecialKey",    s:gui03, "", s:cterm03, "", "", "")
call <sid>hi("TooLong",       s:gui07, "", s:cterm07, "", "", "")
call <sid>hi("Underlined",    s:gui07, "", s:cterm07, "", "", "")
call <sid>hi("Visual",        s:gui08, s:gui06, s:cterm08, s:cterm06, "", "")
call <sid>hi("VisualNOS",     s:gui01, "", s:cterm01, "", "", "")
call <sid>hi("WarningMsg",    s:gui01, "", s:cterm01, "", "", "")
call <sid>hi("WildMenu",      s:gui00, s:gui10, s:cterm00, "", "", "")
...
call <sid>hi("StatusLineNC",  s:gui07, s:gui01, s:cterm07, s:cterm01, "none", "")
...
call <sid>hi("PMenu",         s:gui07, s:gui04, s:cterm07, s:cterm04, "none", "")
call <sid>hi("PMenuSel",      s:gui07, s:gui05, s:cterm07, s:cterm05, "", "")
call <sid>hi("TabLine",       s:gui07, s:gui01, s:cterm07, s:cterm01, "none", "")
call <sid>hi("TabLineFill",   s:gui07, s:gui01, s:cterm07, s:cterm01, "none", "")
...
call <sid>hi("DiffFile",     s:gui07, s:gui00,  s:cterm07, s:cterm00, "", "")
call <sid>hi("DiffNewFile",  s:gui11, s:gui00,  s:cterm11, s:cterm00, "", "")
call <sid>hi("DiffLine",     s:gui13, s:gui00,  s:cterm13, s:cterm00, "", "")
call <sid>hi("DiffRemoved",  s:gui07, s:gui00,  s:cterm07, s:cterm00, "", "")

" Git highlighting
call <sid>hi("gitcommitOverflow",       s:gui07, "", s:cterm07, "", "", "")
...
call <sid>hi("gitcommitUnmergedFile",   s:gui07, "", s:cterm07, "", "bold", "")
call <sid>hi("gitcommitDiscardedFile",  s:gui07, "", s:cterm07, "", "bold", "")
...
call <sid>hi("jsThis",              s:gui07, "", s:cterm07, "", "", "")
call <sid>hi("jsClassDefinition",   s:gui10, "", s:cterm10, "", "", "")
call <sid>hi("jsFunction",          s:gui14, "", s:cterm14, "", "", "")
call <sid>hi("jsFuncName",          s:gui06, "", s:cterm06, "", "", "")
call <sid>hi("jsFuncCall",          s:gui06, "", s:cterm06, "", "", "")
call <sid>hi("jsClassFuncName",     s:gui06, "", s:cterm06, "", "", "")
...
" SASS highlighting
call <sid>hi("sassidChar",     s:gui07, "", s:cterm07, "", "", "")
...
call <sid>hi("SpellBad",     "", "", "", "", "undercurl", s:gui07)
